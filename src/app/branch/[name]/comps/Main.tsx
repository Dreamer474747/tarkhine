...
export default function Main() {
	...
	return (
		<main className="rtl">
			...
			<Link
				href="/menu"
				className={`flex justify-items rounded text-primary w-[152px] sm:w-[184px]
				h-8 sm:h-10 mx-auto border border-primary leading-[180%] ${EstedadMedium}
				-m-2 mb-7 text-xs sm:text-base`}
			>
				<svg className="ml-1 w-4 sm:w-6 h-4 sm:h-6" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
