...
const AboutUs = () => {
	...
	return (
		<div
			id="about-us"
			className="h-fit sm:h-[800px] xl:h-[390px] mt-16"
		>

            <div
				className={`container flex flex-col xl:flex-row justify-between items-center
				rtl h-full py-12 text-white`}
			>
                <div
					id="info"
					className={`md:w-4/5 lg:w-2/3 xl:w-1/2 h-1/2 xl:h-full flex flex-col
					justify-around xl:justify-between text-justify`}
				>

                    <h4 className="text-2xl leading-[140%]">رستوران‌های زنجیره‌ای ترخینه</h4>
                    <p
						className="text-xs sm:text-xl leading-[180%] my-6 sm--md:my-0"
					>
						مهمان‌نوازی یکی از مهم‌ترین مشخصه‌های ایرانیان است و باعث افتخار
                        ماست که بیش از 20 سال است خدمت‌گزار مردم شریف ایران هستیم. ما در رستوران‌های زنجیره‌ای ترخینه
                        همواره تلاش کردیم که در محیطی اصیل بر پایه معماری و طراحی مدرن در کنار طبیعتی دلنواز، غذایی سالم
                        و درخور شان شما عزیزان ارائه دهیم.</p>

                    <Button
						className={`flex justify-items h-10 w-[184px] mb-4 sm:mb-0
						border self-end rounded bg-transparent
						focus:outline !focus:outline-black`}
					>
                        اطلاعات بیشتر
                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M15.5003 20.67C15.3103 20.67 15.1203 20.6 14.9703 20.45L8.45027 13.93C7.39027 12.87 7.39027 11.13 8.45027 10.07L14.9703 3.55002C15.2603 3.26002 15.7403 3.26002 16.0303 3.55002C16.3203 3.84002 16.3203 4.32002 16.0303 4.61002L9.51027 11.13C9.03027 11.61 9.03027 12.39 9.51027 12.87L16.0303 19.39C16.3203 19.68 16.3203 20.16 16.0303 20.45C15.8803 20.59 15.6903 20.67 15.5003 20.67Z"
                                fill="white" />
                        </svg>
                    </Button>
                ...
                <div
					...
					max-w-[392px] flex-wrap w-full sm:[&>*]:w-1/2 mt-12 sm:mt-0`}
                >

                    <div className="flex flex-col justify-items mb-10">
                        <div>
                        ...
                        <h5 className="text-lg leading-[180%] mt-2">پرسنلی مجرب و حرفه‌ای</h5>
                    </div>
                    ...
                    <div className="flex flex-col justify-items mb-10">
                        ...
                        <h5 className="text-lg leading-[180%] mt-2">کیفیت بالای غذاها</h5>
                    </div>

                    <div className="flex flex-col justify-items mb-10 sm:mb-0">
                        <div>
                            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h5 className="text-lg leading-[180%] mt-2">محیطی دلنشین و آرام</h5>
                    </div>
                    ...
                    <div className="flex flex-col justify-items">
                        ...
                        <h5 className="text-lg leading-[180%] mt-2">منوی متنوع</h5>
                    </div>
