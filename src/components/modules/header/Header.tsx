	...
	return (
		<header>
			...
			>
				...
				<div
					className="text-white flex justify-items mt-4 sm:mt-9 select-none"
				>
					<h4
						className={`w-[91px] sm:w-[184px] h-6 sm:h-10 bg-primary
						rounded sm:rounded-lg flex justify-items text-[10px] sm:text-base
