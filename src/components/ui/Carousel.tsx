    ...
    return (
      <div ref={ref} className={`flex justify-center ${props.className}`}>
        {Array.from({ length: numberOfSlides }, (_, i) => (
          <Button
            key={i}
            className={`mx-[0.0625rem] sm:mx-0.5 h-1 sm:h-2 w-1 sm:w-2 rounded-full p-0 ${
              i === currentSlide
                ? 'scale-150 transform bg-primary hover:bg-[#adadad] mx-0.5 sm:mx-1'
                : 'bg-[#adadad] hover:bg-[#adadad]'
            }`}
...
CarouselPrevious.displayName = "CarouselNext2"
